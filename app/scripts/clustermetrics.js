...
angular.module('oshinkoConsole')
  .directive('clusterMetrics', function($interval,
                                           $parse,
                                           $timeout,
                                           $q,
                                           $rootScope,
    ...
    return {
      ...
      link: function(scope) {
        ...
        scope.metrics = [{
          ...
          compactType: 'spline',
          chartID: "threads-active-" + scope.uniqueID
        }, {
          ...
          compactType: 'spline',
          chartID: "vm-heap-mem" + scope.uniqueID
        }, {
          label: "Pod Memory",
          units: "MiB",
          convert: ConversionService.bytesToMiB,
        ...
        ClusterMetricsService.getMetricsURL().then(function(url) {
        ...
        function processData(newData) {
          ...
          scope.showAverage = _.size(scope.pods) > 7 || compact;
        ...
        function getConfig() {
          ...
          config.containerName = scope.containers;
        ...
        function update() {
          ...
          ClusterMetricsService.getClusterMetrics(config).then(processData, metricsFailed).finally(function() {
        ...
        // Updates immediately and then on options or pods changes.
